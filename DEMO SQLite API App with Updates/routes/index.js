...
//    ======================================================================================
    exports.api_bookcodes = function(request, response) {
      // /api/songs?title=Girl
      //responds to client with JSON data
      console.log("RUNNING FIND SONGS JSON API")
      ...
      let sql = "SELECT bookcode, title FROM bookcodes WHERE bookcode LIKE ? OR  title LIKE ? LIMIT 30"
      let title = '%' //sql match anything character
      if (urlObj.query['title']) {
        title = `%${urlObj.query['title']}%`
        console.log("finding title: " + urlObj.query['title'])
    ...
    exports.api_bookcodeDetails = function(request, response) {
      ...
      console.log("API: GET BOOK DETAILS: " + songID)
...
//===========================================================================================
    exports.api_bookupdate_code = function(request, response) {
