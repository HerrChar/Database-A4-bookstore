...
app.get('/api/bookcodes', routes.api_bookcodes)// get bookcode
app.get('/api/bookcode/*', routes.api_bookcodeDetails)//
app.post('/api/bookcode/*', routes.api_bookupdate_code)//update data for  a bookcode
//start server
